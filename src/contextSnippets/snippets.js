exports.snippets = {
	...
	"Snippet: Upgrade Function (Database)": {
		...
		"body": [
			...
			"\t$0",
			"",
			"\tUpgradeTag.SetDatabaseUpgradeTag(Return${1:FeatureName}UpgradeTag());",
			"end;",
			"",
			"#region Return${1:FeatureName}UpgradeTag",
			"internal procedure Return${1:FeatureName}UpgradeTag(): Text[250]",
...
exports.functionSnippetsWithObjectType = {
...
exports.simpleFunctionSnippets = {
	"Snippet: SimpleFunction": {
		"description": "Snippet Simple Function without publishers",
		"prefix": "rSimpleFunction (ALTB)",
		"body": [
			"//#region ${1:MethodName}",
			"local procedure ${1:MethodName}(var ${2:Parameter})",
			"begin",
			"\t$0",
			"end;",
			"//#endregion ${1:MethodName}"
	...
	"Snippet: Function": {
		...
		"body": [
			"//#region ${1:MethodName}",
			"local procedure Do${1:MethodName}(var ${2:Parameter}; Handled: Boolean)",
			"begin",
			"\tif Handled then exit;",
			"\t$0",
			"end;",
			"",
			"//#region MainFunction And Publishers",
			"internal procedure ${1:MethodName}(var ${2:Parameter})",
			"var",
			"\tHandled: Boolean;",
			"begin",
			"\tOnBefore${1:MethodName}(${2/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tDo${1:MethodName}(${2/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tOnAfter${1:MethodName}(${2/^([^:]+):.*$/$1/});",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnBefore${1:MethodName}(var ${2:Parameter}; var Handled : Boolean)",
			"begin",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnAfter${1:MethodName}(var ${2:Parameter})",
			"begin",
			"end;",
			"//#endregion MainFunction And Publishers",
			"//#endregion ${1:MethodName}"
	...
	"Snippet: Function With Confirmation": {
		...
		"body": [
			...
			"\tHandled: Boolean;",
			"begin",
			"\tif not Confirm${1:MethodName}(${2/^([^:]+):.*$/$1/}) then exit;",
			"",
			"\tOnBefore${1:MethodName}(${2/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tDo${1:MethodName}(${2/^([^:]+):.*$/$1/}, Handled);",
			...
			"end;",
			"",
			"local procedure Confirm${1:MethodName}(var ${2:Parameter}): Boolean",
			"var",
			"\tLbl${1:MethodName}: Label '${5:Are you sure?}';",
			"begin",
			"\tif not GuiAllowed or ${2/^([^:]+):.*$/$1/}.GetHideValidationDialog() then exit(true);",
			"\texit(Confirm(Lbl${1:MethodName}));",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
	...
	"Snippet: Function2": {
		...
		"body": [
			"//#region ${1:MethodName}",
			"local procedure Do${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; Handled: Boolean)",
			"begin",
			"\tif Handled then exit;",
			"\t$0",
			"end;",
			"",
			"//#region MainFunction And Publishers",
			"internal procedure ${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2})",
			"var",
			"\tHandled: Boolean;",
			"begin",
			"\tOnBefore${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tDo${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tOnAfter${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/});",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnBefore${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; var Handled : Boolean)",
			"begin",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnAfter${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2})",
			"begin",
			"end;",
			"//#endregion MainFunction And Publishers",
			"//#endregion ${1:MethodName}"
	...
	"Snippet: Function3": {
		...
		"body": [
			"//#region ${1:MethodName}",
			"local procedure Do${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; var ${4:Parameter3}; Handled: Boolean)",
			"begin",
			"\tif Handled then exit;",
			"\t$0",
			"end;",
			"",
			"//#region Main Function And Publishers",
			"internal procedure ${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; var ${4:Parameter3})",
			"var",
			"\tHandled: Boolean;",
			"begin",
			"\tOnBefore${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/}, ${4/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tDo${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/}, ${4/^([^:]+):.*$/$1/}, Handled);",
			"",
			"\tOnAfter${1:MethodName}(${2/^([^:]+):.*$/$1/}, ${3/^([^:]+):.*$/$1/}, ${4/^([^:]+):.*$/$1/});",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnBefore${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; var ${4:Parameter3}; var Handled : Boolean)",
			"begin",
			"end;",
			"",
			"[IntegrationEvent(false, false)]",
			"local procedure OnAfter${1:MethodName}(var ${2:Parameter1}; var ${3:Parameter2}; var ${4:Parameter3})",
			"begin",
			"end;",
			"//#endregion MainFunction And Publishers",
			"//#endregion ${1:MethodName}"
	...
	"Snippet: Data Codeunit": {
		"prefix": "rdatacodeunit (ALTB)",
		"body": [
			"codeunit ${1:Id} \"${2:Feature} Data\"",
			"{",			
			"\tAccess = Public;",
            "\tEventSubscriberInstance = Manual;",           
            "",
			"\tinternal procedure Set${3:Value}(New${3:Value}: ${4:DataType})",
            "\tbegin",
            "\t\tCurr${3:Value} := New${3:Value};",
            "\tend;",
            "",
            "\t/// <summary>",
            "\t/// Get the ${3:Value} for the current transaction",
            "\t/// </summary>",
            "\t/// <returns>${3:Value}</returns>",
            "\tprocedure Get${3:Value}() ${3:Value}: ${4:DataType}",
            "\tbegin",
            "\t\tOnGet${3:Value}(${3:Value});",
            "\tend;",
            "",
            "\t[IntegrationEvent(false, false)]",
            "\tlocal procedure OnGet${3:Value}(var ${3:Value}: ${4:DataType})",
            "\tbegin",
            "\tend;",
            "",
            "\t[EventSubscriber(ObjectType::Codeunit, Codeunit::\"${2} Data\", OnGet${3:Value}, '', false, false)]",
            "\tlocal procedure \"${2/(.*)/${0:/pascalcase}/}Data_OnGet${3:Value}\"(var ${3:Value}: ${4:DataType})",
            "\tbegin",
            "\t\t${3:Value} := Curr${3:Value};",
            "\tend;",
            "",
            "\tvar",
            "\t\tCurr${3:Value}: ${4:DataType};",
            "",
            "\t// 1. Start transaction",
            "\t//",
            "\t//\tvar",
            "\t//\t\t${2/(.*)/${0:/pascalcase}/}Data: codeunit \"${2} Data\";",
            "\t//\tbegin",
            "\t//\t\tBindSubscription(DocumentLayoutData);",
            "\t//\t\t${2/(.*)/${0:/pascalcase}/}Data.Set${3:Value}(${3:Value})",
            "\t//\tend;",
            "\t//",
            ...
            "\t//\t\t${3:Value}: ${4:DataType};",
            "\t//\tbegin",            
            "\t//\t\t${2/(.*)/${0:/pascalcase}/}Data.Get${3:Value}(${3:Value})",
            "\t//\tend;",
            "}"
		],
		"description": "Data Codeunit"
	}
}
